  ...
  return (
    <>
      ...
      <Box>
        ...
        >
          Nous sommes une guilde HL ayant pour objectif de clean chaque raid en
          HM.
          <br />
    ...
    <>
      ...
      <Box>
        ...
        >
          ...
          <div>
            <p>
              La politesse est très importante, " Bonjour" et " Au revoir " sont
              ...
              sont pas tolérés.
              <br /> Le commerce entre membres de la guilde est très mal vu. En
              cas de problème entre un ou plusieurs membres, veuillez le régler
              en privé et non sur le canal de guilde. Les membres qui ont
              connaissance de problèmes de comportement de joueurs de la guilde
              sont tenus de les faire remonter au chef de guilde ou à un
              officiers, ceci dans le but de ne pas détériorer l’ambiance et de
          ...
          <div>
            <p>
              Nous rappelons que la banque de guilde n’est pas là pour un usage
              personnel. La politesse va de soit, quand vous prenez quelque
              chose, vous devez remettre autre chose d’utile. Il ne s'agit pas
              de profiter des ressources accumulées dans les coffres pour monter
              ses métiers sans rien redonner en retour. Pensez aux autres et
              remplissez la quand vous le pouvez.
            </p>
          </div>
          <br />
          ...
          <div>
            <p>
              Chez nous les grades sont attribués au mérite des membres, plus le
              membre est actif et s'investit dans la guilde plus il pourra avoir
              un grade important Chaque grade à ses droits et ses spécificités.
            </p>
            <br />
            <p>
            ...
            <br />
            <p>
              Banquier : il s'agit de reroll d'officier qui ont besoin de garder
              la main sur la banque de guilde.
            </p>
            <br />
            <p>
              Champion : membres les plus actifs et les plus aguerris pour faire
              progresser la guilde dans le contenu HL du jeu.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              recrutement les nouvelles recrues devront notifier dans la section
              Présentation IRL du formulaire de recrutement leur préférence
              entre :Mac Donald's Ou Burger King.
            </p>
          </div>
          <br />
          ...
          <div>
            <p>
              ...
              lire le règlement.
              <br /> En cas de conflits internes et externes ( notamment envers
              les guildes alliées) il doivent les régler dans les plus brefs
              délais et rapporter les incidents dans un mail adressé au chef.
              Ils doivent également participer activement au forum de la guilde.
            </p>
          </div>
          <br />
          ...
          <div>
            <p>
              Le joueur devra être présent régulièrement. Le joueur devra avoir
              prit connaissance du règlement. Le joueur devra être prêt à
              participer à la vie de la Guilde, notamment sur le forum, et à
              s’intégrer à celle-ci. Le joueur devra faire preuve de sympathie,
              de maturité. Il devra être de niveau 110, en cas d'exception et si
              la personne est motivée et volontaire une exception pourra être
              faite. Si ce joueur est recruté par une personne autre que le chef
              ou ses officiers un rapport devra être fait sous forme de mail (
              ou mp via forum) adressé au chef.
              <br />
              <br />
          ...
          <div>
            <p>
              ...
              provocations > Avertissement. Commerce des ressources et objets de
              la banque de guilde > Exclusion définitive.
              <br />
          ...
          <p>
            ...
            gracieusement financé par le chef et les membres les plus impliqués,
            nous avons tous le droit d'en faire partie...
          </p>
        </div>
      </Box>
    </>
